...
![img](https://pic1.zhimg.com/80/v2-d754d8b7b5a883b3951e83995b747dac_720w.jpg)一图看完本文

## 一、 计算机网络体系结构分层

![img](https://pic4.zhimg.com/80/v2-4bfacc0410626e602c48768ad52bf95f_720w.jpg)计算机网络体系结构分层

![img](https://pic3.zhimg.com/80/v2-a2f27ed7520c2bc8c30e0a00e35667d2_720w.jpg)计算机网络体系结构分层
...
![img](https://pic3.zhimg.com/80/v2-30ccc42ffeb8024f0690162fa6124f5a_720w.jpg)网际协议群
...
![img](https://pic2.zhimg.com/80/v2-53781c5fd0dbd8ed1d3be96224c43ebd_720w.jpg)数据包首部
...
![img](https://pic4.zhimg.com/80/v2-8149ac257c0302d7225af9fe5879cfa7_720w.jpg)数据处理流程
...
![img](https://pic1.zhimg.com/80/v2-a113a8db62a54695ade2343ad59c5470_720w.jpg)通过端口号识别应用

**1.2 通过 IP 地址、端口号、协议号进行通信识别**

- 仅凭目标端口号识别某一个通信是远远不够的。

![img](https://pic2.zhimg.com/80/v2-8a60633e78b5bebb22fb8d2a275b3bfd_720w.jpg)

![img](https://pic2.zhimg.com/80/v2-a05b4345c43790d5a67eda4854edd9d5_720w.jpg)通过端口号、IP地址、协议号进行通信识别
...
![img](https://pic4.zhimg.com/80/v2-0253cf94c3eb9f8531ba292d498aa44b_720w.jpg)三次握手
...
![img](https://pic2.zhimg.com/80/v2-43be8bdd87d5c31e1db7672ebd9af1e9_720w.jpg)四次挥手
...
![img](https://pic1.zhimg.com/80/v2-212a4a0539bd6f2490b72c1afd4b81dc_720w.jpg)同时挥手
...
![img](https://pic1.zhimg.com/80/v2-0e3e5ca91edce40bd6f4e6283e9f3ebc_720w.jpg)序列号和确认应答
...
![img](https://pic3.zhimg.com/80/v2-c3c8e7488c60875e04c074c88155369a_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-8c1da62581a8e28d875e70e37e8d6dff_720w.jpg)滑动窗口
...
![img](https://pic1.zhimg.com/80/v2-738c61850a4ce1b843e86910202288c0_720w.jpg)部分确认应答丢失
...
![img](https://pic1.zhimg.com/80/v2-17264b60838fa1d71ecd3ba873aae180_720w.jpg)高速重发控制
...
![img](https://pic2.zhimg.com/80/v2-6397c3a65ec53778816b09e916a13db1_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-2458ff53d2f5487ba3269848b7220937_720w.jpg)IP地址的主机标识

- 如下图，IP 包被转发到途中某个路由器时，正是利用目标 IP 地址的网络标识进行路由。因为即使不看主机标识，只要一见到网络标识就能判断出是否为该网段内的主机。

![img](https://pic4.zhimg.com/80/v2-f8341973a9eafb85caa3096e2195daa3_720w.jpg)IP地址的网络标识
...
![img](https://pic2.zhimg.com/80/v2-79277aa391c8ba8e6b6817a272fcf2c9_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-4e920ca46845f11a0e54366c8626f77f_720w.jpg)

- 第二种表示方式是，在每个 IP 地址后面追加网络地址的位数用 “/ ” 隔开，如下：

![img](https://pic3.zhimg.com/80/v2-55e829887ee10ba9795c51782887895e_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-091bad404d6770adb3f888398eca1152_720w.jpg)路由控制表与 IP 包发送
...
![img](https://pic2.zhimg.com/80/v2-539b9d8cd8e7169366188d32a4370395_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-f2eeb79572c6e146eec85dc51179306b_720w.jpg)全局单播地址

4.5 链路本地单播地址

- 链路本地单播地址是指在同一个数据链路内唯一的地址。它用于不经过路由器，在同一个链路中的通信。通常接口 ID 保存 64 比特版的 MAC 地址。

![img](https://pic1.zhimg.com/80/v2-707638c4f2953cb8076925a97935b08c_720w.jpg)链路本地单播地址
...
![img](https://pic4.zhimg.com/80/v2-6a8b00ff1edb18e4d75187330144a167_720w.jpg)唯一本地地址
...
![img](https://pic3.zhimg.com/80/v2-977b2b9c0e9cd605be3cdd4be04f3a12_720w.jpg)夹着 IPv4 网络的两个 IPv6 网络
